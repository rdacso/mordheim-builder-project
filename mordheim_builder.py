...
firebase = firebase.FirebaseApplication('https://mordheim-builder.firebaseio.com/', None)
warband_input = {
  'sisters of sigmar': {
...
warband_creation_data = {
    'characters': {}
}

def band_choice():
    warband = raw_input('Which warband would you like to play? ')
    if warband in warband_input.keys():
        details = raw_input(warband_input[warband_creation_data[warband].lower()])
        warband_data = warband_input[warband_creation_data[warband]]
